...
const set<complexKey> PWvlet::valid = { {4, 0, 0},
	...
	//need to look at evaluation accuracy for further values (e.g., use KahanSum to re-evaluate the numerator and 
	//	denominator of the GoF when this is greater than 1, recalculate a in the same way under these circumstances
